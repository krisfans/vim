...
" "     vim-clap Keymap
if !has("nvim") && dein#tap("LeaderF")
    nnoremap <silent> <Leader>fh :<C-u>Leaderf mru<CR>
    nnoremap <silent> <Leader>ff :<C-u>Leaderf file<cr>
    nnoremap <silent> <Leader>fc :<C-u>Leaderf colorscheme<CR>
    nnoremap <silent> <Leader>fb :<C-u>Leaderf buffer<CR>
    nnoremap <silent> <Leader>fg :<C-u>Leaderf rg<CR>
    " nnoremap <silent> <Leader>fm :<C-u>Leaderf marks<CR>
    nnoremap <silent> <Leader>fk :<C-u>Leaderf keymaps<CR>
endif
